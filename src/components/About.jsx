...
const About = () => {
  ...
  return (
    <section id="about" className="section-padding bg-surface/80 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-4 sm:-right-6 bg-white/90 dark:bg-slate-950/90 p-6 rounded-lg shadow-xl shadow-primary/10 border-l-4 border-primary backdrop-blur">
              <span className="block text-3xl font-bold text-primary">{profile.stats[0].value}</span>
