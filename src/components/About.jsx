        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-text-secondary text-lg mb-6 leading-relaxed">
              I am a passionate Full Stack Developer with over 5 years of experience in creating dynamic and user-centric web applications. I specialize in React, Node.js, and modern CSS frameworks like Tailwind.
            </p>
