      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-4 sm:-bottom-6 -right-2 sm:-right-6 bg-white/90 dark:bg-slate-950/90 p-4 sm:p-6 rounded-lg shadow-xl shadow-primary/10 border-l-4 border-primary backdrop-blur">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-primary font-semibold mb-3 uppercase tracking-widest text-xs sm:text-sm">
              About Me
            </h3>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-4 sm:mb-6">
              I Build Modern Web Experiences That Scale
            </h2>
            <p className="text-text-secondary text-sm sm:text-base md:text-lg mb-4 sm:mb-6 leading-relaxed">
            ...
            <p className="text-text-secondary text-sm sm:text-base md:text-lg mb-6 sm:mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-10">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="text-center p-2.5 sm:p-4 bg-white/85 dark:bg-slate-950/70 rounded-lg shadow-lg shadow-slate-900/5 border border-primary/10"
                >
                  <div className="text-primary mb-1.5 flex justify-center text-lg sm:text-xl">
                    {stat.icon}
                  </div>
                  <div className="text-lg sm:text-2xl font-bold mb-0.5">{stat.value}</div>
                  <div className="text-[8px] sm:text-[10px] uppercase tracking-wider text-text-secondary">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
