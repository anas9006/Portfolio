...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-10 grid md:grid-cols-2 gap-4 md:gap-12 items-center">
        <motion.div
        ...
        >
          <motion.h2
            ...
            className="text-primary font-semibold mb-2 flex items-center uppercase tracking-[0.2em] text-xs sm:text-sm"
          >
            <span className="w-6 h-[2px] bg-primary mr-2"></span>
            Hello, I am
          </motion.h2>
          <div className="mb-3 sm:mb-6">
            <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
              Muhammad
            </h1>
            <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
              Anas
          ...
          <div className="min-h-12 sm:min-h-20 mb-3 sm:mb-6">
            <div className="animated-sheen inline-flex flex-col gap-2 rounded-lg border border-primary/25 bg-white/75 px-3 py-2.5 sm:px-4 sm:py-3 shadow-xl shadow-primary/10 backdrop-blur-md dark:bg-slate-950/70">
              <span className="text-base sm:text-xl md:text-2xl text-text-secondary font-semibold">
                {typedRole}
                <span className="ml-1 inline-block h-5 sm:h-7 w-[2px] translate-y-0.5 sm:translate-y-1 bg-primary animate-pulse" />
              </span>
            </div>
          </div>
          <p className="text-text-secondary text-sm sm:text-base md:text-lg mb-4 sm:mb-8 max-w-lg leading-relaxed">
            Crafting beautiful, high-performance web applications with a focus
            on user experience and clean architecture.
          </p>
          <div className="grid max-w-xl grid-cols-3 gap-1.5 sm:gap-3 mb-4 sm:mb-8">
            {profile.stats.map((stat, index) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="rounded-lg border border-slate-200/80 bg-white/70 p-2 sm:p-3 shadow-sm backdrop-blur dark:border-white/10 dark:bg-slate-950/55"
              >
                <span className="block text-base sm:text-xl md:text-2xl font-black text-text-primary">
                  {stat.value}
                </span>
                <span className="mt-0.5 block text-[8px] sm:text-xs font-semibold uppercase tracking-wide text-text-secondary">
                  {stat.label}
                </span>
              </motion.div>
            ))}
        ...
        >
          ...
          <motion.div
            ...
            className="mx-auto mt-4 flex w-fit items-center gap-2 rounded-full border border-emerald-500/20 bg-white/85 px-3.5 py-2 text-[10px] sm:text-sm font-semibold text-emerald-700 shadow-lg shadow-emerald-900/5 backdrop-blur dark:bg-slate-950/75 dark:text-emerald-300"
          >
            <span className="relative flex h-2 w-2.5">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-500 opacity-60" />
              <span className="relative inline-flex h-2 w-2.5 rounded-full bg-emerald-500" />
            </span>
