        ...
        >
          ...
          <div className="grid max-w-xl grid-cols-3 gap-3 mb-8">
            {profile.stats.map((stat, index) => (
              ...
              >
                <span className="block text-xl md:text-2xl font-black text-text-primary">
                  {stat.value}
                </span>
                <span className="mt-1 block text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-text-secondary">
                  {stat.label}
                </span>
              </motion.div>
            ))}
