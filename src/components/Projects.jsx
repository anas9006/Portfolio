...
const ProjectCard = ({ project }) => {
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
      className="group relative bg-white/90 dark:bg-slate-950/75 rounded-lg overflow-hidden shadow-lg shadow-slate-900/5 hover:shadow-2xl hover:shadow-primary/15 transition-all duration-500 border border-primary/10 backdrop-blur"
    >
      {/* Image Container */}
      <div className="aspect-video overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-primary/75 to-accent/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-6">
          ...
          <a href={project.liveUrl} aria-label={`Ask about ${project.title}`} className="p-3 bg-white text-slate-900 rounded-full hover:scale-110 transition-transform shadow-lg">
